...
public abstract class PaginationAbstactService<T extends PKNature<K>, K extends Serializable> implements PaginationService<T, K> {
    ...
    /**
     * Must using @Autowired annotation cause need wire repository and concrete dao repository from inherit class !!
     * 
     * @param repository
     *            concrete repository
     */
    public PaginationAbstactService(JpaRepository<T, Serializable> repository) {
    ...
    @Override
    public boolean isLazy(T t) {
        PersistenceUnitUtil unitUtil = entityManagerFactory.getPersistenceUnitUtil();
        return unitUtil.isLoaded(t);
